...
void Sandbox2D::OnUpdate(Fountain::Timestep ts)
{
...

	{
		...
		Fountain::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, m_CloudTexture, 10.0f);
		Fountain::Renderer2D::DrawQuad({ -5.0f, -5.0f, 0.0f }, { 1.0f, 1.0f }, m_CloudTexture, 20.0f);
