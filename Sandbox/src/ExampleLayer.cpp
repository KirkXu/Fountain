	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	Fountain::Ref<Fountain::VertexBuffer> vertexBuffer = Fountain::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Fountain::Ref<Fountain::IndexBuffer> indexBuffer = Fountain::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	...
	Fountain::Ref<Fountain::VertexBuffer> squareVB = Fountain::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ Fountain::ShaderDataType::Float3, "a_Position" },
	...
	Fountain::Ref<Fountain::IndexBuffer> squareIB = Fountain::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
	...
	m_Texture = Fountain::Texture2D::Create("assets/textures/Checkerboard.png");
	m_ChernoLogoTexture = Fountain::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(Fountain::Timestep ts)
{
	// Update
	m_CameraController.OnUpdate(ts);

	// Render
	Fountain::RenderCommand::SetClearColor({ 0.1f, 0.1f, 0.1f, 1 });
...
void ExampleLayer::OnEvent(Fountain::Event& e)
{
